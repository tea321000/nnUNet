...
from nnunet.network_architecture.generic_UNet_rep_mds import Generic_UNet_rep_mds
...
class nnUNetTrainerV2_rep_mds(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet_rep_mds(self.num_input_channels, self.base_num_features, self.num_classes,
